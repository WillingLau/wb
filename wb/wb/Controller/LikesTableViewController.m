...
@interface LikesTableViewController ()<JumpToURL_Protocol>

@property(nonatomic,strong) NSMutableArray *statusFrames;//存放所有收藏微博的模型和数据
...
- (void)viewDidLoad {
    ...
    self.likeFileName = [plistPath stringByAppendingPathComponent:@"LikeStatus.plist"];
    NSArray *likesDataArr = [[NSArray alloc] initWithContentsOfFile:self.likeFileName];
    
    self.likeDataArr = [[NSMutableArray alloc]init];
    [self.likeDataArr addObjectsFromArray:likesDataArr];
}
